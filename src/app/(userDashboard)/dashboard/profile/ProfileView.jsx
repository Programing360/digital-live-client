        ...
        <div className="flex flex-col sm:flex-row items-center gap-6">
          ...
          <div className="relative shrink-0">
            <Avatar size="lg">
              <Avatar.Image
                ...
                className="w-64 h-24 ring-4 ring-slate-100 dark:ring-zinc-800"
              />
          ...
          <div className="flex-1 text-center sm:text-left space-y-2 w-full min-w-0">
            <div className="flex flex-col sm:flex-row sm:items-center gap-2.5 justify-center sm:justify-start">
              ...
              {isPremiumUser ? (
                <Chip
                  ...
                  startContent={
                    <Crown size={11} className="text-amber-500 animate-pulse" />
                  }
                >
                  Premium Member
                </Chip>
            ...
            <p className="text-slate-400 dark:text-zinc-500 font-semibold text-sm flex items-center justify-center sm:justify-start gap-1.5 truncate">
              <Mail size={15} className="text-slate-300 dark:text-zinc-600" />{" "}
              {user?.email}
            </p>
            ...
            <div className="flex gap-5 justify-center sm:justify-start text-xs font-bold text-slate-400 dark:text-zinc-500 pt-2 border-t border-slate-50 dark:border-zinc-800/40 sm:border-0">
              <div>
                <span className="text-slate-900 dark:text-zinc-100 text-sm font-black mr-1">
                  {userPublishLesson.length}
                </span>
                Lessons Published
              </div>
              <div className="hidden sm:block text-slate-200 dark:text-zinc-800">
                |
              </div>
              <div>
                <span className="text-slate-900 dark:text-zinc-100 text-sm font-black mr-1">
            ...
            >
              <div className="flex justify-between items-start gap-2">
                <Chip
                  ...
                  variant="flat"
                  color="primary"
                  className="font-extrabold text-[10px] bg-indigo-50 dark:bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 rounded-lg"
                >
                  {item.category}
                </Chip>
              ...
              <div className="flex justify-between items-center border-t border-slate-50 dark:border-zinc-800/40 pt-3.5">
                ...
                <Link href={`/publicLessons/${item._id}`}>
                  <Button
                    ...
                    variant="light"
                    color="primary"
                    className="font-bold text-xs dark:text-violet-400"
                  >
                    Read Details
                  </Button>
                </Link>
