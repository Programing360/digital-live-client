      ...
      <div className="w-full max-w-5xl bg-white border border-slate-100/80 rounded-[32px] shadow-[0_20px_50px_-12px_rgba(0,0,0,0.03)] grid grid-cols-1 lg:grid-cols-12 overflow-hidden min-h-[580px]">
        ...
        >
          ...
          <div className="relative flex py-5 items-center">
            ...
            <span className="flex-shrink mx-4 text-[11px] font-bold text-slate-400 uppercase tracking-widest">or login with</span>
            <div className="flex-grow border-t border-slate-100"></div>
          </div>
          ...
          <p className="text-xs font-semibold text-slate-400 text-center mt-6">
            New to our space?{" "}
            <Link href="/auth/register" className="text-xs font-extrabold text-indigo-600 hover:underline">
              Create an Account
            </Link>
          </p>
        </motion.div>
        ...
        >
          ...
          >
            ...
            <div className="w-40 h-40 rounded-full bg-white/10 flex items-center justify-center border border-white/10 mb-6 relative">
              ...
              <div className="absolute inset-0 rounded-full border border-dashed border-white/20 animate-spin" style={{ animationDuration: '25s' }} />
            </div>
            ...
            <p className="text-indigo-100/80 text-xs font-medium leading-relaxed mt-2 max-w-[240px]">
              Access saved profiles and review private logs safely from any device endpoint.
            </p>
          </motion.div>
        </motion.div>
