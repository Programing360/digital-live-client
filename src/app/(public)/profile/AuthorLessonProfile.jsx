...
//         description:
//           "Discover how shift parameters and dynamic outlook controls optimize everyday lifestyle success frameworks and build long-term psychological resilience.",
//         category: "Mindset",
//         tone: "Motivational",
...
//         description:
//           "Deconstructing massive personal transformations into daily 2-minute actionable execution cycles that stick past initial motivational bursts.",
//         category: "Growth",
//         tone: "Neutral",
...
//         description:
//           "An empirical deep-dive into compounding lifestyle growth, highlighting why persistent execution overrides occasional hyper-focused production sprints.",
//         category: "Growth",
//         tone: "Grateful",
...
//         description:
//           "How to gracefully establish psychological boundaries at work to maximize long-term output and protect your creative sanity.",
//         category: "Career",
//         tone: "Motivational",
              ...
              <Avatar>
                {author?.image ? (
                  <Avatar.Image
                    ...
                    className="ring-4 ring-indigo-500/10 shadow-md"
                  />
                ) : (
                  <Avatar.Fallback>{getInitials(author?.name)}</Avatar.Fallback>
                )}
              </Avatar>
              <div className="space-y-2 flex-grow">
                <div>
                  <div className="flex flex-col sm:flex-row sm:items-center gap-2">
                    ...
                    <Chip
                      size="xs"
                      className="bg-indigo-500/10 text-indigo-600 font-bold self-center sm:self-auto text-[10px]"
                    >
                      {author.role}
                    </Chip>
                  </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center justify-between">
                        <Chip
                          size="sm"
                          variant="flat"
                          className={`text-[10px] font-bold border  ${toneColorMap[lesson.emotionalTone] || "bg-neutral-100"}`}
                        >
