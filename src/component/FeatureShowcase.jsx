...
import { Sparkles, MessageSquare, Mail, MessageCircle, Zap } from "lucide-react";
  ...
  return (
    <section className="w-full min-h-[700px] flex items-center justify-center bg-gradient-to-b from-white to-slate-50/50 dark:from-[#2a0e65] dark:to-[#17053c] text-slate-900 dark:text-white py-16 px-6 sm:px-12 lg:px-16 overflow-hidden relative select-none transition-colors duration-500">
      ...
      <div className="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center relative z-10">
        ...
        >
          <motion.div variants={textItemVariants} className="flex items-center gap-2 px-3 py-1 bg-indigo-50 dark:bg-[#00e5b4]/10 border border-indigo-100 dark:border-[#00e5b4]/20 rounded-full">
            <Sparkles size={12} className="text-indigo-600 dark:text-[#00e5b4]" />
            <span className="text-[10px] font-black text-indigo-600 dark:text-[#00e5b4] uppercase tracking-widest">
              Platform Showcase
            </span>
          </motion.div>

          <motion.h2 variants={textItemVariants} className="text-4xl sm:text-5xl font-black tracking-tight leading-[1.1] max-w-md">
            AI-Powered{" "}
          ...
          <motion.p variants={textItemVariants} className="text-sm font-medium leading-relaxed text-slate-500 dark:text-purple-200/50 max-w-sm">
            Centralise your customer conversations in one shared inbox with AI, workflows, broadcasts, analytics and more at your finger tips. Bring your customer conversations into one platform.
          </motion.p>
        ...
        <div className="lg:col-span-7 flex items-center justify-center relative w-full h-[450px] sm:h-[500px]">
          ...
          >
            ...
            <motion.div variants={counterRotation} className="absolute -top-4"><Avatar src="https://i.pravatar.cc/100?img=33" size="sm" isBordered className="border-white dark:border-purple-950" /></motion.div>
            <motion.div variants={counterRotation} className="absolute -bottom-4"><Avatar src="https://i.pravatar.cc/100?img=12" size="sm" isBordered className="border-white dark:border-purple-950" /></motion.div>
            <motion.div variants={counterRotation} className="absolute -left-4"><Avatar src="https://i.pravatar.cc/100?img=60" size="sm" isBordered className="border-white dark:border-purple-950" /></motion.div>
            <motion.div variants={counterRotation} className="absolute -right-4"><Avatar src="https://i.pravatar.cc/100?img=47" size="sm" isBordered className="border-white dark:border-purple-950" /></motion.div>
          </motion.div>
          ...
          >
            <div className="w-24 h-24 sm:w-28 sm:h-28 rounded-full bg-gradient-to-br from-indigo-600 to-indigo-800 dark:from-purple-900 dark:to-indigo-950 flex flex-col items-center justify-center text-white border-4 border-white dark:border-[#2a0e65] shadow-inner relative group cursor-pointer">
              <span className="text-lg font-black tracking-tighter lowercase select-none">cue</span>
              <div className="absolute -bottom-1 right-5 p-1 bg-emerald-500 dark:bg-[#00e5b4] rounded-full border-2 border-white dark:border-[#2a0e65]">
                <Zap size={8} className="text-white dark:text-[#17053c] fill-current" />
              </div>
            </div>
          </motion.div>
