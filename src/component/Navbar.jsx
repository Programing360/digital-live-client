...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-4 z-50 mx-auto w-[95%] max-w-7xl">
      <div className="rounded-3xl border border-white/20 bg-white/70 shadow-[0_8px_40px_rgba(0,0,0,0.08)] backdrop-blur-2xl dark:border-white/10 dark:bg-black/40">
