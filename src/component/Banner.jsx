...
import image1 from "../../public/social media network.svg";
// Custom UI Vector Icons
const SparkleIcon = () => (
  <svg
    className="w-3.5 h-3.5 text-indigo-600 dark:text-[#00e5b4]"
    fill="currentColor"
    viewBox="0 0 24 24"
  >
...
const BookmarkIcon = () => (
  <svg
    className="w-3.5 h-3.5 text-neutral-400 dark:text-purple-300/40"
    fill="none"
    stroke="currentColor"
    strokeWidth="2.5"
    viewBox="0 0 24 24"
...
const digitalLessons = [
  {
    ...
    description:
      "Capture your life insights, structure core experiences, and index personal breakthroughs systematically inside a trusted enterprise framework.",
    accentText:
      "from-indigo-600 to-purple-600 dark:from-[#00e5b4] dark:to-teal-300",
    card1: {
      name: "Sarah Ahmed",
      time: "2 hours ago",
      avatar:
  ...
  },
  {
    ...
    description:
      "Master the architecture of cognitive filtering. Close ambient headspaces that no longer serve your core execution metrics.",
    accentText:
      "from-teal-600 to-emerald-600 dark:from-[#00e5b4] dark:to-cyan-200",
    card1: {
      name: "Ayesha Rahman",
      time: "3 hours ago",
      avatar:
  ...
  },
  {
    ...
    description:
      "Systematically scale from your atomic lifestyle data. Map daily compound behaviors into macro career and wellness transformations.",
    accentText:
      "from-purple-600 to-pink-600 dark:from-purple-300 dark:to-fuchsia-300",
    card1: {
      name: "Tanvir Saim",
      time: "10 mins ago",
      avatar:
...
export default function HeroSection() {
  ...
  return (
    <section className="relative w-full min-h-[calc(100vh-4rem)] flex items-center justify-center overflow-hidden  dark:from-[#2a0e65] dark:via-[#182957] dark:to-[#182957] text-white py-16 px-6 md:px-12 lg:px-16 select-none transition-colors duration-700 bg-[#182957]">
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black tracking-tight text-white leading-[1.12]">
                ...
                <span
                  className={`block bg-gradient-to-r ${slide.accentText} bg-clip-text text-transparent transition-all duration-700 mt-1`}
                >
              ...
              <div className="flex items-center gap-3.5 pt-2">
                <Button
                  className="bg-indigo-600 dark:bg-[#00e5b4] text-white dark:text-[#17053c] font-black px-8 shadow-xl shadow-indigo-600/10 dark:shadow-[0_0_25px_rgba(0,229,180,0.25)] transition-all hover:scale-[1.02] active:scale-[0.98]"
                  radius="xl"
                >
                  Start Sharing
                </Button>
                <Link href="/publicLessons">
                  <Button
                    variant="bordered"
                    className="border-slate-200 dark:border-purple-500/20 bg-white dark:bg-purple-950/20 text-slate-700 dark:text-purple-100 hover:bg-slate-50 dark:hover:bg-purple-900/40 font-bold md:px-8 shadow-sm transition-all"
                    radius="xl"
                  >
                    Explore Lessons
                  </Button>
          ...
          <div className="w-full max-w-lg bg-white/80 dark:bg-purple-950/10 backdrop-blur-xl border border-slate-200/60 dark:border-purple-500/10 rounded-2xl p-5 shadow-sm dark:shadow-none mt-8 grid grid-cols-4 gap-2 text-center transition-all">
            {[
              ...
              <div
                ...
                className={
                  idx !== 0
                    ? "border-l border-slate-200/60 dark:border-purple-500/10"
                    : ""
                }
              >
                <h3 className="text-base sm:text-lg font-black text-indigo-600 dark:text-[#00e5b4]">
                  {stat.val}
                </h3>
                <p className="text-[9px] font-black text-slate-400 dark:text-purple-300/30 mt-0.5 uppercase tracking-wider">
                  {stat.lab}
                </p>
              </div>
            ))}
      ...
      <div className="absolute bottom-0 left-0 w-full opacity-10 dark:opacity-20 pointer-events-none select-none">
        ...
        >
          <path
            d="M0,96C120,85.3,240,64,360,58.7C480,53,600,64,720,74.7C840,85,960,96,1080,90.7C1200,85,1320,64,1380,53.3L1440,43V120H1380C1320,120,1200,120,1080,120C960,120,840,120,720,120C600,120,480,120,360,120C240,120,120,120,0,120Z"
