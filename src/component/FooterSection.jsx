    ...
    <footer className="w-full bg-gradient-to-b from-slate-50/40 to-slate-100/80 dark:from-[#2a0e65] dark:to-[#17053c] border-t border-slate-200/80 dark:border-purple-500/20 text-slate-500 dark:text-purple-200/60 font-sans relative overflow-hidden select-none">
      ...
      <div className="absolute bottom-0 left-0 w-full max-w-[600px] opacity-20 pointer-events-none hidden dark:block">
        ...
        >
          ...
          />
          <path
            d="M0,140 Q125,100 250,140 T500,140"
            stroke="#00e5b4"
            strokeWidth="0.25"
            fill="none"
          />
      ...
      >
        ...
        <motion.div
          ...
          className="md:col-span-4 flex flex-col items-start gap-4"
        >
          <div className="flex items-center gap-3">
            <div className=" bg-gradient-to-br from-indigo-500 to-indigo-600 dark:from-[#00e5b4]/10 dark:to-[#00e5b4]/20 border border-indigo-200 dark:border-[#00e5b4]/30 rounded-2xl text-white dark:text-[#00e5b4] shadow-md shadow-indigo-500/10 dark:shadow-[0_0_20px_rgba(0,229,180,0.15)]">
          ...
          <p className="text-xs font-semibold leading-relaxed max-w-xs text-slate-500/90 dark:text-purple-200/40 pr-4">
            An advanced cognitive ledger system designed to map, optimize, and
            catalog critical life metrics into actionable blueprints.
          </p>
        </motion.div>
        ...
        >
          <h4 className="text-[10px] font-black text-indigo-600 dark:text-[#00e5b4] uppercase tracking-widest">
            Explore
          </h4>
          <ul className="flex flex-col gap-3 text-xs font-bold">
            {["Home", "Public Lessons", "Pricing", "About Us"].map((link) => (
              <li key={link}>
                <Link
                  href="#"
                  className="text-slate-600 hover:text-indigo-600 dark:text-purple-200/70 dark:hover:text-[#00e5b4] transition-colors duration-200 font-bold flex items-center gap-0.5 group/link"
                >
                  {link}
                  <ArrowUpRight
                    size={11}
                    className="opacity-0 -translate-y-0.5 -translate-x-0.5 group-hover/link:opacity-100 group-hover/link:translate-y-0 group-hover/link:translate-x-0 transition-all duration-200"
                  />
                </Link>
              </li>
            ))}
        ...
        >
          ...
          <div className="flex flex-col gap-1 mt-1 p-3 bg-white/80 dark:bg-purple-950/20 border border-slate-200 dark:border-purple-500/10 backdrop-blur-md rounded-2xl w-full max-w-xs shadow-sm dark:shadow-none">
            ...
            <a
              ...
              className="text-xs font-black text-slate-800 dark:text-purple-100 hover:text-indigo-600 dark:hover:text-[#00e5b4] transition-colors mt-0.5 break-all"
            >
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-5 flex flex-col sm:flex-row items-center justify-between gap-4 text-[11px] font-bold text-slate-400 dark:text-purple-300/30">
          ...
          <div className="flex items-center gap-5">
            ...
            <span className="flex items-center gap-1.5 text-slate-400 dark:text-purple-300/30">
              ...
              <span className="text-slate-600 dark:text-purple-200/60">
                Node Online
              </span>
            </span>
          </div>
