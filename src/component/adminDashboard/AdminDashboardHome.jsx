...
const chartData = [
  { month: "Jan", users: 12, lessons: 8 },
  { month: "Feb", users: 18, lessons: 11 },
  { month: "Mar", users: 25, lessons: 19 },
  { month: "Apr", users: 30, lessons: 23 },
  { month: "May", users: 42, lessons: 31 },
  { month: "Jun", users: 55, lessons: 40 },
];
...
export default function AdminDashboardHome({
  ...
  const publicLessonCount = allLesson.filter(
  ...
  const statCards = [
    ...
    },
    {
      ...
      value: `${publicLessonCount.length}`,
      change: "+8.2%",
  ...
  return (
    <div className="min-h-screen bg-default-50/40 p-4 md:p-8 space-y-8 max-w-[1600px] mx-auto">
      ...
      >
        <div>
          ...
          <p className="text-sm text-default-400 mt-1">
            Platform metrics health monitoring analytics dashboard.
          </p>
        </div>
        <div className="flex gap-2">
          ...
          <Button
            size="sm"
            className="bg-indigo-600 text-white font-bold radius-lg shadow-md shadow-indigo-500/20"
          >
            Platform Settings
          </Button>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
              ...
              <div className="p-5 flex flex-col justify-between h-40">
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <h3 className="text-3xl font-black mt-1.5 text-slate-800 dark:text-white">
                      {stat.value}
                    </h3>
                  </div>
                ...
                <div className="flex items-center gap-1 z-10">
                  ...
                  <span className="text-[10px] text-default-400 font-medium ml-1">
                    vs last week
                  </span>
                </div>
              </div>
        ...
        <div>
          <GrowthChart chartData={allGrowth}></GrowthChart>
        </div>
            ...
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="text-xs text-default-400 mt-0.5">
                  Visual representation of user and content creation influx
                  streams.
                </p>
              </div>
              <div className="flex gap-2 bg-default-100/70 p-1 rounded-xl">
                <Button
                  size="xs"
                  variant="light"
                  className="bg-white dark:bg-zinc-800 shadow-xs text-xs font-bold px-3"
                >
                  Growth
                </Button>
                <Button
                  size="xs"
                  variant="light"
                  className="text-xs text-default-400 px-3"
                >
                  History
                </Button>
              </div>
            ...
            <div>
              <div className="flex justify-between items-center mb-5">
                <div>
                  ...
                  <p className="text-xs text-default-400 mt-0.5">
                    Most active weekly content publishers.
                  </p>
                </div>
                <Button
                  size="sm"
        ...
        <Card className="border border-slate-100 dark:border-zinc-800 rounded-[24px] bg-white dark:bg-zinc-900 shadow-sm p-6">
          <div className="flex justify-between items-center mb-5">
            <div>
              ...
              <p className="text-xs text-default-400 mt-0.5">
                Realtime view of digital life lessons created today.
              </p>
            </div>
            <Chip
            ...
            <table className="w-full min-w-[750px] text-left border-collapse">
              ...
              <tbody className="divide-y divide-default-100/60 dark:divide-zinc-800/60">
                {mockTodayLessons.map((lesson, idx) => (
                  <tr
                    key={idx}
                    className="hover:bg-default-50/40 dark:hover:bg-white/[0.01] transition-colors text-xs font-medium text-slate-700 dark:text-zinc-300"
                  >
                    <td className="p-4 font-bold text-slate-800 dark:text-zinc-100">
                      {lesson.title}
                    </td>
                    ...
                    <td className="p-4 text-default-400 font-semibold">
                      {lesson.tone}
                    </td>
                    <td className="p-4 text-right">
                      <div className="flex gap-2 justify-end">
                        <Button
                          ...
                          color="success"
                          variant="flat"
                          className="font-bold text-[11px] h-7 min-w-0 px-3 rounded-lg"
                        ...
                        <Button
                          ...
                          color="default"
                          variant="light"
                          className="font-bold text-[11px] h-7 min-w-0 px-2 rounded-lg"
                        >
